...
const Event: Component<{ data: EventData }> = ({ data }) => {
  return (
    <div className="flex flex-col rounded-3xl bg-white border-solid border-2">
      <div
      ...
      <div className="flex flex-col w-full md:flex-row rounded-b-3xl">
        ...
        <div className="font-normal text-gray-800 md:w-3/4">
          <p className="p-4 leading-normal font-supply">{data.content[0]}</p>
          <div className="p-2 rounded-b-3xl md:rounded-b-none mt-5 md:rounded-br-3xl text-center bg-green-hacked hover:transition-colors hover:duration-300 hover:bg-green-hacked-darker hover:cursor-pointer">
            <a
              target="_blank"
              href={data.link}
